...
author: "N. Moon, S. Caetano, and S. Schwartz"
...
Your complete .Rmd file that you create for these practice problems AND the resulting pdf (i.e., the one you 'Knit to PDF' from your .Rmd file) must be uploaded into a Quercus assignment (link: [https://q.utoronto.ca/courses/253019/assignments/796337](https://q.utoronto.ca/courses/253019/assignments/792571)) by 11:59 a.m. ET, on Thursday, January 20, 2022. Late problem sets or problems submitted another way (e.g., by email) are *not* accepted.
...
The test was set up as follows: 8 cups of tea were made, 4 with milk in first and 4 with tea in first, and, without seeing which version was being given to her Dr. Bristol would choose whether she thought the tea or the milk was poured in first.
...
n_observations <- 80
test_stat <- 47/n_observations # your test statistic
...
Your friends just finished participating in a new version of the British Tea experiment and had so much fun that they want you to come up with an entirely new experiment (except one that does NOT involve drinking tea any more)! If you don't know what they're talking about, check out the  *Optional Question 3* from *Part 1* -- just reviewing the prompt will be enough to get you "in the know" about what your friends are going on about. Then, help your friends come up with a hypothesis that you could test using a simulation test! You should do the following:  
