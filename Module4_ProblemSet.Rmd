...
Your peers just finished participating in a new version of the British Tea experiment and had so much fun that they want you to come up with an entirely new experiment (except one that does NOT involve drinking tea any more)! Help your peers come up with a hypothesis that you could test using a simulation test. You should do the following:  
